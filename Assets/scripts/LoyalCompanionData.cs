...
[CreateAssetMenu(fileName = "LoyalCompanion", menuName = "Companion/Loyal Companion")]
public class LoyalCompanionData : CompanionData
{
    private void OnEnable()
    {
        companionName = "Loyal Companion";
    ...
    private bool TryLoadSavedStats()
    {
        ...
        // Loyal companion has medium cooldown (3-4 hours)
        cooldownHours = Random.Range(3, 5);
