...
[CreateAssetMenu(fileName = "AggressiveCompanion", menuName = "Companion/Aggressive Companion")]
public class AggressiveCompanionData : CompanionData
{
    private void OnEnable()
    {
        companionName = "Aggressive Companion";
        description = "A fierce companion focused on high damage output and courage.";
    ...
    private bool TryLoadSavedStats()
    {
        ...
        if (StatPointsManager.Instance != null)
        {
            ...
            // Aggressive companion has longer cooldown (4-6 hours)
            cooldownHours = Random.Range(4, 7);
